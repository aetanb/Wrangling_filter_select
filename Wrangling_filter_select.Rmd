...
After running the code above, I was able to determine that there are eight "Batman" movies. 
...
I believe the code doesn't work because it is in the incorrect order. 
...
After the running the previous code, I concluded that the longest movie was "The Cure for Insomnia" with 5220 minutes and that the oldest movie was "Blacksmith Scene" releasing in 1893. 
...
After running the code above, I found that 1248 movies released in 1995. 
...
Comedy movies with an MPAA rating, length over 120 minutes, and have a rating above 8 consist of Big Fish, Forrest Gump, Homem Que Copiava, and The Incredibles.
...
After running the code above, I was able to conclude that there are three movies that include "Harry Potter" in the title: Harry Potter and the Chamber of Secrets, Harry potter and the Prisoner of Azkaban, and Harry Potter and the Sorcerer's Stone. The movie with the highest rating was the Prisoner of Azkaban, whole the movie with the highest votes was The Sorcerer's Stone. 
...
The highest budget for a movie that is an animation or comedy is "Wild Wild West" with a budget of 170 million
